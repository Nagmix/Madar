...
class _RegisterScreenPlaceholder extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_RegisterScreenPlaceholder> createState() => _RegisterScreenPlaceholderState();
}

class _RegisterScreenPlaceholderState extends ConsumerState<_RegisterScreenPlaceholder> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(controller: _nameController, decoration: const InputDecoration(labelText: 'Full Name', prefixIcon: Icon(Icons.person_outlined))),
            const SizedBox(height: 16),
            TextFormField(controller: _emailController, keyboardType: TextInputType.emailAddress, decoration: const InputDecoration(labelText: 'Email', prefixIcon: Icon(Icons.email_outlined))),
            const SizedBox(height: 16),
            TextFormField(controller: _phoneController, keyboardType: TextInputType.phone, decoration: const InputDecoration(labelText: 'Phone Number (optional)', prefixIcon: Icon(Icons.phone_outlined))),
            const SizedBox(height: 16),
            TextFormField(controller: _passwordController, obscureText: true, decoration: const InputDecoration(labelText: 'Password', prefixIcon: Icon(Icons.lock_outlined))),
            const SizedBox(height: 8),
            if (authState.error != null)
              Container(
                ...
                child: Text(authState.error!, style: const TextStyle(color: Colors.red, fontSize: 14), textAlign: TextAlign.center),
              ),
            const SizedBox(height: 16),
            ElevatedButton(
  ...
  void _handleRegister() {
    ref.read(authProvider.notifier).register(name: _nameController.text.trim(), email: _emailController.text.trim(), password: _passwordController.text);
  }
}
...
class _RatingScreenWrapper extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_RatingScreenWrapper> createState() => _RatingScreenWrapperState();
}
