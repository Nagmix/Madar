...
/// Uses Nominatim for place search instead of Google Places API
                ...
                : _searchResults.isNotEmpty
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _buildSearchResultItem(place);
                        },
                      )
                    : _buildSavedPlaces(),
          ),

          // Vehicle selection (when destination is set)
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  mapState.pickupAddress ?? 'Current Location',
          ...
          if (mapState.dropoffAddress != null) ...[
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () => ref.read(mapLocationProvider.notifier).clearDropoff(),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('Search for a destination', style: TextStyle(color: Colors.grey[500])),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _vehicleOption(Icons.directions_car, 'Sedan', VehicleType.sedan),
              const SizedBox(width: 8),
              _vehicleOption(Icons.local_taxi, 'Comfort', VehicleType.suv),
              const SizedBox(width: 8),
              _vehicleOption(Icons.airport_shuttle, 'Van', VehicleType.van),
            ],
          ),
        ],
      ),
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Text(name, style: TextStyle(fontSize: 11, fontWeight: selected ? FontWeight.w600 : FontWeight.normal)),
            ],
          ),
        ),
      ),
